...
export const apiKey = 'f379b750fd188bc3ec72f0760d768302'
const tmdbEndpoint = 'https://api.themoviedb.org/3/movie'
const tmdbEndpointSearch = 'https://api.themoviedb.org/3/search/movie'
const tmdbEndpointGenre = 'https://api.themoviedb.org/3/genre/movie/list'
export const tmdbAPI = {
  ...
  getMovieGenre: () => `${tmdbEndpointGenre}?api_key=${apiKey}`,
